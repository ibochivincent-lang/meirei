          ...
          <div className="grid grid-cols-1 gap-10 lg:grid-cols-12">
            ...
            <div className="space-y-12 lg:col-span-9 max-w-3xl">
              ...
              <section id="otp-architecture" className="space-y-4 rounded-2xl border border-ink-200 bg-white p-6 sm:p-8 shadow-xs">
                <h2 className="font-display text-2xl font-bold text-ink-950">3. 2FA Cryptographic Authorization Barrier</h2>
                <p className="text-ink-700 leading-relaxed">
              ...
              {/* API Reference */}
              <section id="api-chat" className="space-y-4 rounded-2xl border border-ink-200 bg-white p-6 sm:p-8 shadow-xs">
                <h2 className="font-display text-2xl font-bold text-ink-950">4. API Reference</h2>
