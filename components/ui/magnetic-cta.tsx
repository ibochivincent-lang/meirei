  ...
  return (
    <span ref={ref}>
      <a
        ...
        data-cursor="grow"
        className={cn(
          "min-h-[44px] inline-flex items-center justify-center gap-2 rounded-md px-4 py-2.5 md:px-6 md:py-3.5 text-sm md:text-base text-white font-medium bg-accent-500 hover:bg-accent-600 transition-colors shadow-sm",
          className,
        )}
      >
        {children}
