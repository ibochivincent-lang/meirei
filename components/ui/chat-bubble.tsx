 ...
 * pale tella-green tint reminiscent of a banking chat; incoming use white.
 *
    ...
    >
      <div
        className={cn(
          ...
          isOutgoing
            ? "rounded-br-md bg-tella-100 text-ink-900"
      ...
      >
        ...
        {time && (
          <span className="mt-0.5 block text-right text-[9px] text-ink-500">
            {time}
            {isOutgoing && <span className="ml-1 text-tella-500">✓✓</span>}
          </span>
        )}
      </div>
    </div>
