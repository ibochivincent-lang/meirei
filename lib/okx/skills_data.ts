...
export const OKX_CEX_MARKET_DATA: CexMarketData = {
  ...
  assetMetrics: {
    ...
    MSTRx: { volume24h: "$2.5M", beta: 2.45, spread: "0.05%", momentumRank: 2 },
    TSLAx: { volume24h: "$3.2M", beta: 1.85, spread: "0.03%", momentumRank: 3 },
    METAx: { volume24h: "$2.7M", beta: 1.32, spread: "0.02%", momentumRank: 4 },
    MSFTx: { volume24h: "$2.9M", beta: 1.05, spread: "0.02%", momentumRank: 5 },
    TSMx: { volume24h: "$2.3M", beta: 1.25, spread: "0.02%", momentumRank: 6 },
    AAPLx: { volume24h: "$3.6M", beta: 0.98, spread: "0.01%", momentumRank: 7 },
    AMDx: { volume24h: "$1.8M", beta: 1.55, spread: "0.03%", momentumRank: 8 },
    QQQx: { volume24h: "$4.1M", beta: 1.15, spread: "0.01%", momentumRank: 9 },
    AMZNx: { volume24h: "$2.4M", beta: 1.18, spread: "0.02%", momentumRank: 10 },
    AVGOx: { volume24h: "$1.6M", beta: 1.30, spread: "0.03%", momentumRank: 11 },
    GOOGLx: { volume24h: "$2.1M", beta: 1.12, spread: "0.02%", momentumRank: 12 },
    MUx: { volume24h: "$1.1M", beta: 1.40, spread: "0.03%", momentumRank: 13 },
    COINx: { volume24h: "$1.9M", beta: 2.10, spread: "0.04%", momentumRank: 14 },
    MRVLx: { volume24h: "$880K", beta: 1.35, spread: "0.03%", momentumRank: 15 },
    SPYx: { volume24h: "$5.2M", beta: 1.00, spread: "0.01%", momentumRank: 16 },
    CRWDx: { volume24h: "$740K", beta: 1.20, spread: "0.03%", momentumRank: 17 },
    DELLx: { volume24h: "$810K", beta: 1.15, spread: "0.02%", momentumRank: 18 },
    IWMx: { volume24h: "$1.3M", beta: 1.22, spread: "0.02%", momentumRank: 19 },
    INTCx: { volume24h: "$950K", beta: 0.92, spread: "0.02%", momentumRank: 20 },
  },
};
